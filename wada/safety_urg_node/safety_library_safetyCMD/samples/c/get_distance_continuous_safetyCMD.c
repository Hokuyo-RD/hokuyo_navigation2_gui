/*
	Sample program to obtain distance data from the sensor using AR02 Command.
	Data is continuously recevied unltil "CTRL+C" is pressed.
		
	Normal execution (default connection)
	> get_distance_continuous_safetyCMD.exe
	
	Execution with spcific IP address
	> get_distance_continuous_safetyCMD.exe 192.168.0.11
	
	�v���R�}���h�ɂ��Z���T���狗���l���擾����T���v���v���O�����iAR02�R�}���h�g�p�j
	AR02�R�}���h���g�p���A�L�[�{�[�h����"CTRL+C"�����͂����܂ŋ����l�̎擾��A���ōs���܂�
	�I������AR03�R�}���h���g�p���A���ꗬ�����[�h���~���܂�
...
int main(int argc, char *argv[])
{
	...
	// �f�[�^�擾
	// AR02���M
	if (safety_sensor_request_distance_continuous_safetyCMD(&sensor) < 0)
	{
	...
	// Stop the data receptoin using AR03 command
	// AR03�R�}���h�ɂ�萂�ꗬ����~
	if (safety_sensor_stop_measurement_distance_safetyCMD(&sensor) == 0)
	{
