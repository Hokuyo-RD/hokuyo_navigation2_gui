/*
	Sample program to obtain distance and intensity data from the sensor using AR01 Command.
	
	Normal execution (default connection)
	> get_distance_intensity_safetyCMD.exe
	
	Execution with spcific IP address
	> get_distance_intensity_safetyCMD.exe 192.168.0.11
	
	�v���R�}���h�ɂ��Z���T���狗���l�ƃ��x���l���擾����T���v���v���O�����iAR01�R�}���h�g�p�j
...
int main(int argc, char *argv[])
{
	...
	// Transmit AR01
	// AR01�R�}���h���M
	if (safety_sensor_request_distance_intensity_handshaking_safetyCMD(&sensor) < 0)
	{
		safety_sensor_close_safetyCMD(&sensor);
		return 2;
	}

	// Receive the distance and intensity
	// �����l���x���l��M
