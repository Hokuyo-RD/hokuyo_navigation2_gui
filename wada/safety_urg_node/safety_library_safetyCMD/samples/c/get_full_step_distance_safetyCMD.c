/*
	Sample program to obtain distance data from the sensor using AR06 Command.
	
	Normal execution (default connection)
	> get_full_step_distance_safetyCMD.exe
	
	Execution with spcific IP address
	> get_full_step_distance_safetyCMD.exe 192.168.0.11
	
	
	�v���R�}���h�ɂ��Z���T���狗���l���擾����T���v���v���O�����iAR06�R�}���h�g�p�j
...
int main(int argc, char *argv[])
{
	...
	// Transmit AR06 command
	// AR06�R�}���h���M
	if (safety_sensor_request_fullstep_distance_handshaking_safetyCMD(&sensor) < 0)
	{
