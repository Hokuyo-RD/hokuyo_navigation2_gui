/*
	Sample program to obtain distance data from the sensor using AR07 Command.
	Data is continuously recevied unltil "CTRL+C" is pressed.
	AR08 Command is used when stopping the continuous mode.
		
	Normal execution (default connection)
	> get_full_step_distance_continuous_safetyCMD.exe
	
	Execution with spcific IP address
	> get_full_step_distance_continuous_safetyCMD.exe 192.168.0.11
	
	
	�v���R�}���h�ɂ��Z���T���狗���l���擾����T���v���v���O�����iAR06�R�}���h�g�p
	AR07�R�}���h���g�p���A�L�[�{�[�h����"CTRL+C"�����͂����܂ŋ����l�̎擾��A���ōs���܂�
	�I������AR08�R�}���h���g�p���A���ꗬ�����[�h���~���܂��j
...
int main(int argc, char *argv[])
{
	...
	// Transmit AR07
	// AR07���M
	if (safety_sensor_request_fullstep_distance_continuous_safetyCMD(&sensor) < 0)
	{
	...
	// Stop the data receptoin using AR08 command
	// AR08�R�}���h�ɂ�萂�ꗬ����~
	if (safety_sensor_stop_measurement_fullstep_distance_safetyCMD(&sensor) == 0)
	{
